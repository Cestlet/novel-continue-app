...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    var maxTokens: Int by mutableStateOf(2048)
    var lengthHint: Int by mutableStateOf(800)
    ...
    private fun loadSettings() {
        viewModelScope.launch {
            ...
            maxTokens = settings.maxTokens.first()
            lengthHint = settings.lengthHint.first()
    ...
    fun saveSettings() {
        viewModelScope.launch {
            ...
            settings.saveMaxTokens(maxTokens)
            settings.saveLengthHint(lengthHint)
